...
const journeyData = [
  {
    ...
    content:
      'Where the past meets the present. This is the initial spark—a profound, personal realization that shifts your perspective and opens the door to something greater than yourself.',
  },
  {
    title: 'TRANSFORMATION',
    subtitle: 'The Process of Becoming',
    content:
      'A continuous, challenging, and rewarding journey of growth. We move from who we were to who we are meant to be, fueled by community and deep reflection.',
  },
  {
    title: 'PURPOSE',
    subtitle: 'The Outward Mission',
    content:
      'Finding your place in the world. Your gifts, experiences, and transformation are channeled into action, bringing light and service to the community and beyond.',
  },
];
...
function JourneyCard({
  ...
  content,
  index,
}: (typeof journeyData)[0] & { index: number }) {
  ...
  return (
    <div ref={cardRef} className="horizontal-card-wrapper">
      <motion.div className="journey-card">
        ...
        <motion.div style={{ y: titleParallaxY }} className="title-container">
          <GradientHeading
            headingAs="h2"
        ...
        <motion.div style={{ y: contentParallaxY }} className="card-content-block">
