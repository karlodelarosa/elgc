...
const slidesData = [
  { title: "Project Alpha", description: "The initial concept and discovery phase. Laying the foundational structure for success." },
  { title: "Phase Two Beta", description: "Development and iteration in progress. We're refining the user experience and core features." },
  { title: "Final Launch Gamma", description: "Ready for deployment! The culmination of months of hard work, now live for the world to see." },
];
...
const HorizontalScroll = () => {
  ...
  useEffect(() => {
    ...
    const setupGSAP = () => {
      ...
      horizontalScroll.to(glowRef.current, {
      ...
      slides.forEach((slide) => {
        ...
        horizontalScroll.fromTo(title, 
          { x: TITLE_PARALLAX_X, opacity: 0.5 }, 
          { x: 0, opacity: 1, ease: "power2.out" }, 
          timelineStart
        );
        horizontalScroll.fromTo(description, 
        ...
        horizontalScroll.to(title, 
          { x: -TITLE_PARALLAX_X, opacity: 0.5, ease: "power2.in" }, 
          timelineEnd 
        );
        horizontalScroll.to(description, 
