...
const sectionData = [
    {
        title: "MISSION",
        content: "To empower individuals and organizations through innovative technology solutions, driving meaningful change globally.",
    },
    {
        title: "VISION",
        content: "To be the leading catalyst for digital transformation, creating a smarter, more connected and sustainable future for all.",
    },
    {
        title: "CORE VALUES",
        content: "INTEGRITY: Acting with honor and strong moral principles. \nCOLLABORATION: Succeeding together by pushing boundaries. \nEXCELLENCE: Achieving the highest quality in every endeavor.",
    },
]
    ...
    return (
        ...
        <section ref={ref} className="mvc-section-item">
            ...
            >
                ...
                >
                    <GradientHeading headingAs="h2" className="text-8xl lg:text-[10rem] font-extrabold tracking-tighter">
                        {title}
                    </GradientHeading>
                </motion.div>
                ...
                >
                    {content.split('\n').map((line, i) => (
                        <p key={i} className="content">{line}</p>
                    ))}
                </motion.div>
            </motion.div>
        </section>
...
export default function MvCSection() {
    ...
    return (
        <div id="mvc-parallax-section" className="bg-[#0a0a0a] bg-[radial-gradient(ellipse_at_top,_var(--tw-color-purple-950)_10%,_transparent_70%)] text-white relative">
