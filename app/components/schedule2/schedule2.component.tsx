              ...
              return (
                <div key={index} className="schedule-item relative">
                  ...
                  <div className={`relative ${isLeft ? 'mr-auto pr-16' : 'ml-auto pl-16'} w-1/2`}>
                    <div className={`bg-zinc-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 ${isLeft ? 'text-right' : 'text-left'}`}>
                      ...
                      <h3 className={`text-3xl bg-gradient-to-r ${item.gradient} bg-clip-text text-transparent mb-2`}>
                        {item.title}
                      </h3>
